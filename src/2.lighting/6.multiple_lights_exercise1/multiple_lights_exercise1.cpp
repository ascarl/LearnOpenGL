// LearnOpenGL 中文导读
// 学习目标：通过沙漠、工厂、恐怖和生化实验室四组参数，比较光色、环境项与衰减对场景氛围的影响。
// 核心流程：每组片段给出背景色、四个点光源颜色，以及方向光/点光/聚光灯的完整 uniform 预设。
// 本练习新增：不改光照算法，只替换颜色和衰减参数即可复用多光源 Shader 塑造截然不同的环境。
// 观察重点：文件含 [...] 占位符且使用旧版 Shader.Program 接口，是配置参考片段而非独立可执行程序。
// == ==============================================================================================
//       DESERT
// == ==============================================================================================
// 沙漠预设使用暖色点光与橙色背景，方向光也偏暖，营造高温、干燥的整体色调。
...
//       FACTORY
// == ==============================================================================================
// 工厂预设以低环境光和偏蓝点光为主，聚光灯衰减较慢，形成冷色工业空间。
...
//       HORROR
// == ==============================================================================================
// 恐怖预设压低全局与点光强度，并缩短光照半径，让大部分场景保持黑暗。
...
//       BIOCHEMICAL LAB
// == ==============================================================================================
// 生化实验室预设采用明亮背景和绿色局部光，用更长照明半径塑造洁净但异样的氛围。
